/**
 * Claude Agent SDK integration for Prefactor observability. Provides automatic tracing of Claude
 * agent runs, LLM calls, tool executions, and subagent workflows via a traced `query` wrapper.
 *
 * ## `@prefactor/claude` overview
 *
 * `@prefactor/claude` connects Claude Agent SDK sessions to Prefactor tracing. It captures agent,
